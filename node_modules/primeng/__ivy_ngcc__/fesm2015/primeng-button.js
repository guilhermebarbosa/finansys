...
ButtonDirective.ɵfac = function ButtonDirective_Factory(t) { return new (t || ButtonDirective)(ɵngcc0.ɵɵdirectiveInject(ElementRef)); };
...
/*@__PURE__*/ (function () { ɵngcc0.ɵsetClassMetadata(ButtonDirective, [{
    ...
    }], function () { return [{ type: ElementRef }]; }, { iconPos: [{
            type: Input
        }], label: [{
            type: Input
        }], icon: [{
